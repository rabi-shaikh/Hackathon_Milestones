...
const shareableLinkContainer = document.getElementById('sherable-link-container') as HTMLDivElement
const shareableLinkElement = document.getElementById('sherable-link') as HTMLAnchorElement
